...
%token NUM VAR BEG END READ WRITE IF THEN ELSE WHILE DO ENDWHILE ENDIF BREAK CONTINUE
%token PLUS MINUS MUL DIV LT GT LTE GTE NE EQ 
%type <t> NUM VAR expr Slist Stmt InStmt OutStmt AsgStmt IfStmt WhileStmt BrkStmt
%left PLUS MINUS
%left MUL DIV

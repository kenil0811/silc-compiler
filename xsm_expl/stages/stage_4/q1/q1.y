...
%type <t> NUM VAR expr Slist Stmt InStmt OutStmt AsgStmt IfStmt WhileStmt BrkStmt DoWhileStmt Type VarList
%left PLUS MINUS
%left MUL DIV
...
program	:	Declarations BEG Slist END 	{codeGen($3, out); return;}
		|	BEG Slist END	{codeGen($2, out); return;}
		|	BEG END			{return;}
		|	Declarations	{displayTable(); return;}
		;
